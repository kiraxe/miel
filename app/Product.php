...
class Product extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'detail', 'article', 'price', 'property','percent', 'min', 'novelty', 'options', 'price_quarterly', 'price_second', 'price_third', 'min_quarterly', 'min', 'min_second', 'min_third', 'popular'
    ];
