export const rus = {
    ...
    'page': {
        ...
        'settings': {
            ...
            'from': "От (квартал)",
            'to': "До (квартал)",
            'description_main_page' : 'Описание',
            'title_main_page' : 'Заголовок',
            'banner_main_page' : 'Картинка',
            'description_other_page' : 'Описание',
            'title_other_page' : 'Заголовок',
            'banner_other_page' : 'Картинка',
